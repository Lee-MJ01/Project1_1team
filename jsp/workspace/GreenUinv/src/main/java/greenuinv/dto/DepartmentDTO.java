...
public class DepartmentDTO {
	...
	public void setCollege_college_name(String college_college_name) {
		this.college_name = college_college_name;
	}
	public String getDepte_name() {
		return dept_name;
	}
	public void setDepte_name(String depte_name) {
		this.dept_name = depte_name;
	}
	...
	public String toString() {
		return "DepartmentDTO [dept_id=" + dept_id + ", college_college_name=" + college_name + ", depte_name="
				+ dept_name + ", dept_name_en=" + dept_name_en + ", established=" + established + ", chair_name="
				+ chair_name + ", dept_phone=" + dept_phone + ", dept_office=" + dept_office + "]";
	}
}
