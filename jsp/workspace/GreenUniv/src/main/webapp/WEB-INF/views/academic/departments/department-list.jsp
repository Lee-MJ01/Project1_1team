...
/* 왼 쪽 사이드바 */
.sideBar {
	background-color: #eaeaea; /*height: 100%; 질문필요*/
	width: 20%;
	margin-left: 30px;
}
...
select, input, .search-bar button {
	height: 35px;
	font-size: 14px;
	padding: 0 8px;
...
<body>
	...
	<div class="topbar">
		<div class="top">
			<a href="#">home</a><span>|</span> <a href="#">사이트맵</a><span>|</span>
			<a href="#">로그아웃</a>
		</div>
		<div class="bottom">
	...
	<div class="menu">
		<div class="sideBar">
			<ul>
				...
				<li class="stylenone"><img
					src="./images/ico-admin-academic.png">학사운영</li>
				<ul class="styletwo">
				...
				<li class="stylenone"><img src="./images/ico-admin-college.png">대학
					및 학과</li>
				<ul class="styletwo">
					<li><a href="#">&middot;교육 운영 현황</a></li>
					<li><a href="#">&middot;교육 운영 현황</a></li>
				</ul>
				<li class="stylenone"><img src="./images/ico-admin-board.png">게시판
					관리</li>
				<ul class="styletwo">
