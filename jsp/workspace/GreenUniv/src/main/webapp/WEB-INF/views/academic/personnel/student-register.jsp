    ...
    <main class="main-area">
      <section class="page">
		...
		<c:choose>
          ...
          <!-- 등록 폼 -->
          <form method="post" action="${pageContext.request.contextPath}/student/write.do" autocomplete="off">
            ...
            <!-- 하단 버튼 -->
            <div class="btns">
              <a href="${pageContext.request.contextPath}/student/list.do"><button class="btn" type="button">목록</button></a>
